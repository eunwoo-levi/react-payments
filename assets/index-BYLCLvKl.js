...
const MASTERCARD_FIRST_DIGIT = "5";
const MASTERCARD_MIN_SECOND_DIGIT = 1;
const MASTERCARD_MAX_SECOND_DIGIT = 5;
const getCardImageSrc = (cardNumber = "") => {
  ...
  if (first === MASTERCARD_FIRST_DIGIT && second >= MASTERCARD_MIN_SECOND_DIGIT && second <= MASTERCARD_MAX_SECOND_DIGIT)
...
const CardBackground = newStyled.div`
...
const CardPreview = newStyled.div`
  ...
  height: 22px;
`;
const PaymentSim = newStyled(CardPreview)`
  background-color: #ddcd78;
  border-radius: 4px;
`;
const CardInfoContainer$1 = newStyled.div`
  display: flex;
  flex-direction: column;
  margin: 14px 13px 0 5px;
  gap: 8px;
`;
const CardNumberContainer = newStyled.div`
  display: flex;
  flex-direction: row;
  width: 100%;
...
`;
const Secret = newStyled(InfoText)`
  letter-spacing: 2px;
`;
...
function Preview({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBackground, { bgColor, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PreviewContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(PaymentSim, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardPreview, { children: imgSrc !== "" && /* @__PURE__ */ jsxRuntimeExports.jsx(CardImage, { src: imgSrc, alt: "cardType" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoContainer$1, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberContainer, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(InfoText, { children: cardNumber[0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(InfoText, { children: cardNumber[1] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Secret, { children: "•".repeat((_a = cardNumber[2]) == null ? void 0 : _a.length) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Secret, { children: "•".repeat((_b = cardNumber[3]) == null ? void 0 : _b.length) })
      ] }),
...
const CardInfoMainSection = newStyled.section`
  width: 100%;
  display: flex;
  flex-direction: column;
  gap: 16px;
`;
const CardInfoTitle = newStyled.h1`
  font-size: 18px;
  font-weight: 700;
`;
const CardInfoDescription = newStyled.span`
  color: #8b95a1;
  font-size: 9.5px;
  font-weight: 400;
`;
const CardInfoSubSection = newStyled.div`
  min-height: 80px;
  display: flex;
  flex-direction: column;
  gap: 8px;
`;
const CardInfoSubTitle = newStyled.span`
  font-size: 12px;
  font-weight: 500;
  line-height: 15px;
`;
const CardInfoInputContainer = newStyled.div`
  display: flex;
  flex-direction: row;
  gap: 10px;
  width: 100%;
`;
const CardInfoError = newStyled.span`
  color: #ff3d3d;
  font-size: 9.5px;
  font-weight: 400;
`;
const CardSelection$1 = newStyled.select`
  width: 100%;
  max-width: 100%;
  padding: 8px;
`;
const CustomInput$1 = newStyled.input`
  flex: 1 1 0;
  min-width: 0;
...
const CustomInput = React.forwardRef(
  ({ type, placeholder, name, onChange, maxLength, error }, ref) => {
...
function CardNumberSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoMainSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoTitle, { children: "결제할 카드 번호를 입력해 주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoDescription, { children: "본인 명의의 카드만 결제 가능합니다." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSubSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoSubTitle, { children: "카드 번호" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoInputContainer, { children: inputArr$2.map((input, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CustomInput,
        {
          ...input,
        ...
        `cardNumber-custom-input-${index}`
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoError, { children: error && error["cardNumberError"].errorMessage })
    ] })
  ] });
}
const inputArr$1 = [
...
function CardExpirationDateSection({
  error,
  onChange
}) {
  const isError = error && error["cardExpirationDateError"].errorIndex !== -1 && error["cardExpirationDateError"].errorMessage !== "";
  const inputRefs = reactExports.useRef([]);
  const handleInputChange = (e, index) => {
    var _a;
    onChange(e);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoMainSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoTitle, { children: "카드 유효기간을 입력해 주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoDescription, { children: "월/년도(MMYY)를 순서대로 입력해 주세요." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSubSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoSubTitle, { children: "유효기간" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoInputContainer, { children: inputArr$1.map((input, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CustomInput,
        {
          ...input,
          onChange: (e) => handleInputChange(e, index),
        ...
        `cardExpirationDate-custom-input-${index}`
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoError, { children: error && error["cardExpirationDateError"].errorMessage })
    ] })
  ] });
}
...
function CardCVCSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoMainSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoTitle, { children: "CVC 번호를 입력해 주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoDescription, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSubSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoSubTitle, { children: "CVC" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoInputContainer, { children: inputArr.map((input, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CustomInput,
        {
          ...input,
          onChange,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoError, { children: error && error["cardCVCError"].errorMessage })
    ] })
  ] });
}
function CardSelection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoMainSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoTitle, { children: "카드사를 입력해 주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoDescription, { children: "현재 국내 카드사만 가능합니다." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSubSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoInputContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardSelection$1, { value: cardIssuer, onChange, name: "cardIssuer", children: [
...
function CardPasswordSection({
  ...
  const isError = error && error["cardPasswordError"].errorIndex !== -1 && error["cardPasswordError"].errorMessage !== "";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoMainSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoTitle, { children: "비밀번호를 입력해 주세요" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoDescription, { children: "앞의 2자리를 입력해주세요" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSubSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoSubTitle, { children: "비밀번호 앞 2자리" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoInputContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        CustomInput,
        {
          type: "password",
          name: "cardPassword",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoError, { children: isError && error["cardPasswordError"].errorMessage })
    ] })
  ] });
}
const NO_ERROR = -1;
...
const cardIssuerValidator = (input) => {
  if (input.length === 0) {
...
const confirmButtonValidator = ({
  ...
  return cardNumberValidator(cardNumber)[0] === NO_ERROR && cardExpirationDateValidator(cardExpirationDate)[0] === NO_ERROR && cardCVCValidator(cardCVC)[0] === NO_ERROR && cardIssuerValidator(cardIssuer)[0] === NO_ERROR && cardPasswordValidator(cardPassword)[0] === NO_ERROR;
};
...
const AppContainer = newStyled.div`
  ...
  min-height: 100vh;
`;
const CardContainer = newStyled.main`
  width: 375px;
...
function useCardInfo() {
  ...
  const handleCardInfoChange = (e) => {
    ...
    if (name.startsWith("cardNumber")) {
      ...
      setCardNumber((prev2) => {
        const updatedNumbers = prev2.map((num, i) => i === index ? value : num);
        validateAndSetError("cardNumber", updatedNumbers, setError);
        return updatedNumbers;
      });
    } else if (name.startsWith("cardExpirationDate")) {
      const key = name.split("-")[1];
      setCardExpirationDate((prev2) => {
        const updateDate = { ...prev2, [key]: value };
...
const CardInfoContext = reactExports.createContext(void 0);
const CardInfoProvider = ({ children }) => {
  const [cardInfos, setCardInfos] = reactExports.useState({
    cardNumber: ["", "", "", ""],
    cardIssuer: "",
  ...
  const updateCardInfos = (newCardInfo) => {
    setCardInfos(newCardInfo);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoContext.Provider, { value: { cardInfos, updateCardInfos }, children });
};
const useCardInfoContext = () => {
  const context = reactExports.useContext(CardInfoContext);
  if (!context) {
    throw new Error("useCardInfoContext must be used within a CardInfoProvider");
  }
  return context;
};
const CustomLinkButton$1 = newStyled.button`
  width: 100%;
  height: 52px;
  size: 16px;
  font-weight: 700;
...
`;
function CustomLinkButton({ path, css: css2 }) {
  const navigate = useNavigate();
  const handleLinkClick = () => {
    navigate(`/${path}`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CustomLinkButton$1, { onClick: handleLinkClick, css: css2, type: "button", children: "확인" });
}
function CardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Preview,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoContainer, { cardInfo, onChange: handleCardInfoChange, error }),
    confirmButtonValidator({ ...cardInfo }) && /* @__PURE__ */ jsxRuntimeExports.jsx(
      CustomLinkButton,
      {
        path: "register",
        css: css`
...
const RegisterPageContainer = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
  ...
  font-weight: 700;
`;
const RegisterImageContainer = newStyled.div`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
  margin-bottom: 50px;
`;
const RegisterCircle = newStyled.div`
  width: 76px;
  height: 76px;
  border-radius: 100%;
  background-color: #333333;
  ...
  align-items: center;
`;
const RegisterMainContainer = newStyled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
function RegisterPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(RegisterPageContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterImageContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterCircle, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./complete.svg", alt: "complete" }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(RegisterMainContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        cardInfos.cardNumber[0],
        "로 시작하는"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        cardInfos.cardIssuer,
        "가 등록되었어요."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const router = () => {
  return createBrowserRouter([
    {
      path: "/",
      element: /* @__PURE__ */ jsxRuntimeExports.jsx(CardPage, {})
    },
    {
      path: "/register",
      element: /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterPage, {})
    }
  ]);
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RouterProvider, { router: router() }) });
}
